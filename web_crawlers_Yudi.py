...
if __name__ == '__main__':
    for i in range(1):# number of pages
        ...
        for url in detail_url:
            ...
            publisher.append(etree.HTML(res.text).xpath('//*[@id="ctl00_ContentPlaceHolder1_lblPublisher"]/text()')[0]) # publisher
...
# 
    ...
    output = open('/Users/yudiwang/Documents/19WinterECE143/Group Project/opentrolley/Fiction_result.csv', 
